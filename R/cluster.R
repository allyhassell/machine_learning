## STAT318/462 Lab 7: Cluster analysis
#
...
# Section 10.5 is given below. I have added R code for computing 
# the silhouette coefficient and distance matrices.

# You should play around with this R code and data in order to 
# explore and gain a feel for how each of the two clustering 
# algorithms work.
...
## This function generates bivariate normal random variables:
rbivariate = function(mean.x = 0, sd.x = 1, mean.y = 0, sd.y = 1, 
                      r = 0, n = 100) {
   z1 = rnorm(n)
   z2 = rnorm(n)
...
## Here is a simulated data set created using the above function:
set.seed(10)
